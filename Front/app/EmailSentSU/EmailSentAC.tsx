...
export default function ActivateEmail() {
    ...
    const EmailSent: TranslationPair = {
        en: "Only one step left to complete your account. Please, Check your email for the verification link.",
        ar: "تبقى خطوة واحدة لإكمال حسابك. يرجى التحقق من بريدك الإلكتروني للحصول على رابط التحقق.",
    }
